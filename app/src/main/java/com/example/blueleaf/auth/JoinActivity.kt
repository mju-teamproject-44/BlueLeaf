...
import com.example.blueleaf.board.BoardEditActivity
                    ...
                    .addOnCompleteListener(this) { task ->
                        if (task.isSuccessful) {
                            ...
                            val mDialogView = LayoutInflater.from(this)
                                .inflate(R.layout.login_success_dialog, null)
                            ...
                            alertDialog.findViewById<Button>(R.id.goMainBtn)?.setOnClickListener {
                                val intent = Intent(this, MainActivity::class.java)
...
//        val mDialogView = LayoutInflater.from(this).inflate(R.layout.login_success_dialog, null)
//        val mBuilder = AlertDialog.Builder(this)
//            .setView(mDialogView)
//            .setTitle("")
//
